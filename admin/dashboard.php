...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <ul class="nav navbar-nav navbar-left navbar-top-links">
            <li><a href="../admin/#"><i class="fa fa-home fa-fw"></i> Website</a></li>
        </ul>
        ...
        <ul class="nav navbar-right navbar-top-links">
            <li class="dropdown navbar-inverse">
                ...
                <ul class="dropdown-menu dropdown-alerts">
                    ...
                    <li class="divider"></li>
                    <li>
                        <a class="text-center" href="../admin/#">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="../admin/#"><i class="fa fa-sitemap fa-fw"></i> Multi-Level Dropdown<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="../admin/#">Second Level Item</a>
                            </li>
                            <li>
                                <a href="../admin/#">Third Level <span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="../admin/#">Third Level Item</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
